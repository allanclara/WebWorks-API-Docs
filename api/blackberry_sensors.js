 ...
 * }
 *
 * // Start listening to the compass sensor with a delay feedback of 1000ms 
...
blackberry.sensors ={
     ...
     * <p>This sensor returns values from the device's magnetometer. Returned as uT (micro Tesla).
     * @param {Object} data The object containing the sensor data.
     * @param {Float} [data.x] The x-axis value.
     * @param {Float} [data.y] The y-axis value.
     * @param {Float} [data.z] The z-axis value.
     ...
     * @param {Object} data The object containing the sensor data.
     * @param {Array} [data.matrix] 3x3 Float array of data values representing the matrix.
     * @event
     * @BB10X
     */
    ...
    /**
     * Device face detection sensor.
     * <p>This sensor returns the status of the holster sensor.
     * @param {Object} data The object containing the sensor data.
     * @param {Number} [data.value] 1 if face is detected, 0 otherwise.
     * @event
     * @BB10X
     */
     ...
     * @param {String} [options.delay] Time in ms to report back between sensor updates
     * @param {Boolean} [options.background] Allow sensor to send updates while app is in background
